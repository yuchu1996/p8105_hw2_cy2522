...
-   From the three different sheets, we can see the dimension of **trash\_df** is 216,14, that of **trash\_bd** is 20, 3; there are variables like `year, month, total`in trash\_bd, or variables like`sports_balls, weight_tons`in trash\_df.
-   The total precipitaion in 2017 is 29.93.
